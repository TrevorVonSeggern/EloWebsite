...
declare namespace angular {
    ...
    interface IAngularStatic {
         ...
         * @param extraModules An optional array of modules that should be added to the original list of modules that the api was about to be bootstrapped with.
         */
    ...
    interface IModule {
        ...
        /**
         * The $HomeController service is used by Angular to create new controllers.
         *
         * This provider allows HomeController registration via the register method.
         *
    ...
    ///////////////////////////////////////////////////////////////////////////
    // ControllerService
    // see http://docs.angularjs.org/api/ng.$HomeController
