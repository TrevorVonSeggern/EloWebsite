...
interface JQuery {
     ...
     * Remove a previously-stored piece of data.
     *
     * @param name A string naming the piece of data to deleteItem or space-separated string naming the pieces of data to deleteItem.
     */
    removeData(name: string): JQuery;
    /**
     * Remove a previously-stored piece of data.
     *
     * @param list An array of strings naming the pieces of data to deleteItem.
     */
