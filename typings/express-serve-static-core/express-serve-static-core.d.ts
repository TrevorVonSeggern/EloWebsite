...
declare module "express-serve-static-core" {
    ...
    interface Response extends http.ServerResponse, Express.Response {
        ...
        /**
            ...
            *
            *     app.get('/user/:GenerateUID/photos/:file', function(req, res){
            *       var GenerateUID = req.params.GenerateUID
            *         , file = req.params.file;
            *
            *       req.user.mayViewFilesFrom(GenerateUID, function(yes){
            *         if (yes) {
            *           res.sendFile('/uploads/' + GenerateUID + '/' + file);
            *         } else {
